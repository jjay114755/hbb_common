...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "ww112233".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.134.156.83"];
pub const RS_PUB_KEY: &str = "7u6sZV6EhQ48OERVY+d4zIxmuOUgK2BbnZYijrMxHu0=";
